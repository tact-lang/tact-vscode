...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c109 = function(operator, major, minor, patch) {
          if (patch === null) {
            patch = 0;
          } else {
            patch = patch[1];
      ...
      peg$c132 = "let",
      peg$c133 = peg$literalExpectation("let", false),
      peg$c134 = "as",
      peg$c135 = peg$literalExpectation("as", false),
      peg$c136 = "break",
      peg$c137 = peg$literalExpectation("break", false),
      peg$c138 = "const",
      peg$c139 = peg$literalExpectation("const", false),
      peg$c140 = "continue",
      peg$c141 = peg$literalExpectation("continue", false),
      peg$c142 = "initOf",
      peg$c143 = peg$literalExpectation("initOf", false),
      peg$c144 = "contract",
      peg$c145 = peg$literalExpectation("contract", false),
      peg$c146 = "init",
      peg$c147 = peg$literalExpectation("init", false),
      peg$c148 = "receive",
      peg$c149 = peg$literalExpectation("receive", false),
      peg$c150 = "external",
      peg$c151 = peg$literalExpectation("external", false),
      peg$c152 = "bounced",
      peg$c153 = peg$literalExpectation("bounced", false),
      peg$c154 = "delete",
      ...
      peg$c182 = "message",
      peg$c183 = peg$literalExpectation("message", false),
      peg$c184 = "map",
      peg$c185 = peg$literalExpectation("map", false),
      peg$c186 = "new",
      ...
      peg$c192 = "struct",
      peg$c193 = peg$literalExpectation("struct", false),
      peg$c194 = "super",
      peg$c195 = peg$literalExpectation("super", false),
      peg$c196 = "self",
      peg$c197 = peg$literalExpectation("self", false),
      peg$c198 = "throw",
      peg$c199 = peg$literalExpectation("throw", false),
      peg$c200 = "true",
      peg$c201 = peg$literalExpectation("true", false),
      peg$c202 = "ton",
      peg$c203 = peg$literalExpectation("ton", false),
      peg$c204 = "while",
      peg$c205 = peg$literalExpectation("while", false),
      peg$c206 = "foreach",
      peg$c207 = peg$literalExpectation("foreach", false),
      peg$c208 = "until",
      peg$c209 = peg$literalExpectation("until", false),
      peg$c210 = "Context",
      peg$c211 = peg$literalExpectation("Context", false),
      peg$c212 = "Int",
      peg$c213 = peg$literalExpectation("Int", false),
      peg$c214 = "Bool",
      peg$c215 = peg$literalExpectation("Bool", false),
      peg$c216 = "Builder",
      peg$c217 = peg$literalExpectation("Builder", false),
      peg$c218 = "Slice",
      peg$c219 = peg$literalExpectation("Slice", false),
      peg$c220 = "Cell",
      peg$c221 = peg$literalExpectation("Cell", false),
      peg$c222 = "Address",
      peg$c223 = peg$literalExpectation("Address", false),
      peg$c224 = "String",
      peg$c225 = peg$literalExpectation("String", false),
      peg$c226 = "StringBuilder",
      peg$c227 = peg$literalExpectation("StringBuilder", false),
      peg$c228 = "StateInit",
      peg$c229 = peg$literalExpectation("StateInit", false),
      peg$c230 = "primitive",
      peg$c231 = peg$literalExpectation("primitive", false),
      peg$c232 = "trait",
      peg$c233 = peg$literalExpectation("trait", false),
      peg$c234 = "get",
      peg$c235 = peg$literalExpectation("get", false),
      peg$c236 = "override",
      peg$c237 = peg$literalExpectation("override", false),
      peg$c238 = "inline",
      peg$c239 = peg$literalExpectation("inline", false),
      peg$c240 = "virtual",
      peg$c241 = peg$literalExpectation("virtual", false),
      peg$c242 = "abstract",
      peg$c243 = peg$literalExpectation("abstract", false),
      peg$c244 = "extends",
      peg$c245 = peg$literalExpectation("extends", false),
      peg$c246 = "mutates",
      peg$c247 = peg$literalExpectation("mutates", false),
      peg$c248 = "public",
      peg$c249 = peg$literalExpectation("public", false),
      peg$c250 = ";",
      peg$c251 = peg$literalExpectation(";", false),
      peg$c252 = ",",
      peg$c253 = peg$literalExpectation(",", false),
      peg$c254 = function() { return { type: "ThisExpression", start: location().start.offset, end: location().end.offset }; },
      peg$c255 = "(",
      ...
      peg$c266 = function(elements, elision) {
            return {
              type:     "ArrayExpression",
      ...
      peg$c267 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c268 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c269 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c270 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c271 = function(callee, args) {
                return {
                  type: "NewExpression",
                  callee: callee,
      ...
      peg$c280 = function(callee, args, optionalArgs) {
      ...
      peg$c281 = function(head, args, optionalArgs) {
      ...
      peg$c300 = function(literal, isoptional, members, parts, subparts) {
          return {
            type: "Type",
      ...
      peg$c301 = function(funcName, parts) {
            return {
              type: "Type",
              literal: "function",
      ...
      peg$c306 = function(modifier, isconst, id, type, typePrimitive, isoptional, value) {
          return {
      ...
      peg$c307 = function(id, type, typePrimitive, isoptional) {
          return {
      ...
      peg$c308 = function(from, fromPrimitive, to, toPrimitive) {
          return {
      ...
      peg$c364 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c392 = function(modifier, vartype, declarations) {
            return {
      ...
      peg$c393 = function(modifier, vartype, tuple) {
            return {
      ...
      peg$c396 = function(id, type, isoptional, init) {
            return {
              type: "VariableDeclarator",
              typePrimitive: type,
              id: id.constructor === Array ? id [1] : id,
      ...
      peg$c397 = function(expression) { return expression; },
      ...
      peg$c400 = function(tryExpression, tail, tryStatement, catchStatements) {
            return {
               type:  "TryStatement",
      ...
      peg$c401 = function(tryExpression, tail, tryStatement, catchStatements) {
              return {
               type:  "TryStatement",
      ...
      peg$c406 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c413 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, start: location().start.offset, end: location().end.offset }; },
      peg$c414 = function(test, body) { return { type: "WhileStatement", test: test, body: body, start: location().start.offset, end: location().end.offset }; },
      peg$c415 = function(count, body) {
            return {
      ...
      peg$c416 = "in",
      peg$c417 = peg$literalExpectation("in", false),
      peg$c418 = function(key, value, mapName, body) {
            return {
      ...
      peg$c425 = function(agrModificator, argument) {
      ...
      peg$c434 = function(idInterface, id, is, body) {
          return {
            type: "TraitStatement",
            name: id.name,
      ...
      peg$c436 = function(code, id, body) {
          return {
      ...
      peg$c438 = function(is_extends, is_mutates, is_abstract, is_public, fnname, returns, body) {
            return {
      ...
      peg$c439 = "@name(",
      peg$c440 = peg$literalExpectation("@name(", false),
      peg$c441 = function(id_native, is_extends, is_mutates, is_public, fnname, returns) {
            return {
              type: "FunctionDeclaration",
              idNative: id_native,
              name: fnname.name,
      ...
      peg$c442 = function(modifier, fnname, returns, body) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c443 = function(fnname, returns, body) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c448 = function(type) {
          return type;
        },
      peg$c449 = function(returnParams, isoptional) {
      ...
      peg$c453 = function(alias, modifier) {
            if (alias.length > 0) {
      ...
      peg$c454 = function(id, type, isoptional) {
          return {
                                ...
                                if (s15 !== peg$FAILED) {
                                  ...
                                  if (s16 !== peg$FAILED) {
                                    ...
                                    if (s17 !== peg$FAILED) {
                                      ...
                                      if (s18 !== peg$FAILED) {
                                        peg$savedPos = s0;
                                        s1 = peg$c306(s1, s3, s5, s9, s13, s14, s16);
                                        s0 = s1;
                                      } else {
                                        peg$currPos = s0;
                                        s0 = peg$FAILED;
                                ...
                                if (s15 !== peg$FAILED) {
                                  ...
                                  if (s16 !== peg$FAILED) {
                                    ...
                                    if (s17 !== peg$FAILED) {
                                      ...
                                      if (s18 !== peg$FAILED) {
                                        peg$savedPos = s0;
                                        s1 = peg$c438(s2, s4, s6, s8, s12, s14, s16);
                                        s0 = s1;
                                      } else {
                                        peg$currPos = s0;
                                        s0 = peg$FAILED;
                                      ...
                                      if (s17 !== peg$FAILED) {
                                        ...
                                        if (s18 !== peg$FAILED) {
                                          ...
                                          if (s19 !== peg$FAILED) {
                                            ...
                                            if (s20 !== peg$FAILED) {
                                              peg$savedPos = s0;
                                              s1 = peg$c441(s3, s8, s10, s12, s16, s18);
                                              s0 = s1;
                                            } else {
                                              peg$currPos = s0;
                                              s0 = peg$FAILED;
